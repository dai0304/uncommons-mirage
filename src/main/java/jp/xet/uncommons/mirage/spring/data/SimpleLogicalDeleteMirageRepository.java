 ...
 * @author daisuke
 */
public abstract class SimpleLogicalDeleteMirageRepository<T> extends SimpleMirageRepository<T, Long> implements
		LogicalDeleteMirageRepository<T> {
	 ...
	 * @param entityClass
	 */
	public SimpleLogicalDeleteMirageRepository(Class<T> entityClass) {
		super(entityClass);
	}
